...
public class p2 {
	public static void main(String[] args) throws Throwable  {
		...
		//deselects the option with index = 0
		s.deselectByIndex(0);
		
		//deselects the option with text = 'Lolipop'
		s.deselectByVisibleText("Lolipop");
		
		//deselects the option with value = 'T'
		s.deselectByValue("T");
		
		//deselects the option with text = PepperPaneer
		s.deSelectByContainsVisibleText("PepperPaneer");
